...
final class PlaylistCommandHandler {
    static final String LIST_BUTTON_PREFIX = "playlist:list:";
    static final String VIEW_BUTTON_PREFIX = "playlist:view:";
    static final String TRACK_REMOVE_CONFIRM_PREFIX = "playlist:track:remove:confirm:";
    static final String TRACK_REMOVE_CANCEL_PREFIX = "playlist:track:remove:cancel:";
    ...
    PlaylistCommandHandler(MusicCommandListener owner) {
        this.owner = owner;
    }
    ...
    void handlePlaylistPrefix(MessageReceivedEvent event, Guild guild, String arg, String lang) {
