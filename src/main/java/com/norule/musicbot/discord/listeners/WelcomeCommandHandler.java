...
final class WelcomeCommandHandler {
    ...
    WelcomeCommandHandler(MusicCommandListener owner) {
        this.owner = owner;
    }
    ...
    void handleWelcomeSlash(SlashCommandInteractionEvent event, String lang) {
        ...
        if (channelOption == null) {
            channelOption = event.getOption(MusicCommandListener.OPTION_WELCOME_CHANNEL_ZH);
        }
        if (channelOption != null) {
    ...
    private Modal buildWelcomeModal(BotConfig.Welcome welcome, String lang) {
        ...
        return Modal.create(MusicCommandListener.WELCOME_MODAL_ID, owner.i18nService().t(lang, "welcome.modal_form_title"))
                .addComponents(
