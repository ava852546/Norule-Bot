...
final class WebMetadataController {
    private final WebControlServer owner;

    WebMetadataController(WebControlServer owner) {
        this.owner = owner;
    }
    ...
    void handleApiWebI18n(HttpExchange exchange) throws IOException {
        ...
        Map<String, Map<String, String>> bundles = owner.webLanguageBundleService().loadWebBundles();
