import { createGeneralSchema } from '/web/modules/schemas/general-schema.js';
import { createLogsSchema } from '/web/modules/schemas/logs-schema.js';
import { createMusicSchema } from '/web/modules/schemas/music-schema.js';
import { createNotificationsSchema } from '/web/modules/schemas/notifications-schema.js';
import { createNumberChainSchema } from '/web/modules/schemas/number-chain-schema.js';
import { createPrivateRoomSchema } from '/web/modules/schemas/private-room-schema.js';
import { createTicketSchema } from '/web/modules/schemas/ticket-schema.js';
import { createWelcomeSchema } from '/web/modules/schemas/welcome-schema.js';
