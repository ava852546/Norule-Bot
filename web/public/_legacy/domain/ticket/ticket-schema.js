export function createTicketSchema({ ticketModule, applyTicketPanelDefaultsIfEmpty }) {
  return {
    fields: [
      ...
      { id: 't_panelButtonStyle', path: 'ticket.panelButtonStyle', type: 'value', default: 'PRIMARY' },
      { id: 't_panelButtonLimit', path: 'ticket.panelButtonLimit', type: 'number', default: 3 },
      { id: 't_preOpenFormEnabled', path: 'ticket.preOpenFormEnabled', type: 'checked', default: false },
      { id: 't_preOpenFormTitle', path: 'ticket.preOpenFormTitle', type: 'value', default: '' },
      { id: 't_preOpenFormLabel', path: 'ticket.preOpenFormLabel', type: 'value', default: '' },
      { id: 't_preOpenFormPlaceholder', path: 'ticket.preOpenFormPlaceholder', type: 'value', default: '' },
      { id: 't_welcomeMessage', path: 'ticket.welcomeMessage', type: 'value', default: '' },
      { id: 't_optionLabels', path: 'ticket.optionLabels', type: 'value', default: '' },
